...
export function JoinWorkspaceCard({
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-[420px] border border-border bg-card p-6 rounded-xl shadow-2xl space-y-6">
        {/* Header Visual */}
        ...
        <div className="bg-muted/40 border border-border/60 rounded-lg p-3.5 space-y-2.5">
        ...
        <div className="pt-2">
          {!isConnected ? (
            <div className="space-y-3">
              <div className="text-center text-[11px] text-amber-500 font-medium bg-amber-500/5 border border-amber-500/10 rounded-md p-2">
