...
export function UploadQueue() {
  ...
  return (
    <div className="fixed bottom-4 right-4 w-80 bg-card border border-border rounded-sm shadow-2xl z-60 overflow-hidden flex flex-col transition-all duration-300">
      {/* Header Widget */}
      <div
