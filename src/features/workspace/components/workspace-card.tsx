...
export function WorkspaceCard({ workspace }: WorkspaceCardProps) {
  ...
  return (
    <Link
      ...
      className="group relative flex flex-col justify-between p-5 bg-card border border-border/70 rounded-xl shadow-xs transition-all duration-300 hover:border-primary/50 hover:shadow-md hover:-translate-y-0.5 cursor-pointer overflow-hidden"
    >
      ...
      <div className="flex items-center justify-between mt-5 pt-2 text-[11px] font-medium text-muted-foreground group-hover:text-primary transition-colors">
        ...
        <div className="flex items-center gap-0.5 bg-muted group-hover:bg-primary group-hover:text-primary-foreground p-1 rounded-md transition-all duration-300">
