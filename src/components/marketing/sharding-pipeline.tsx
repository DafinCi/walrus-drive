...
export function ShardingPipeline() {
  ...
  return (
    <div
      ...
      className="w-full bg-zinc-950/60 border border-zinc-800/80 rounded-[6px] p-6 flex flex-col justify-between overflow-hidden relative min-h-[180px] cursor-pointer group"
    >
      <div className="flex items-center justify-between w-full z-10">
        ...
        <div className="flex flex-col items-center gap-1.5 w-16">
          <div
            className={cn(
              "p-2.5 bg-zinc-900 border rounded-[6px] transition-all duration-300",
              isHovered
        ...
        <div className="grid grid-cols-2 gap-1.5">
          {[1, 2, 3, 4].map((node) => (
            <div
              key={node}
              className={cn(
                "p-1.5 bg-zinc-900/50 border rounded-[6px] flex items-center justify-center transition-all duration-500",
                isHovered
