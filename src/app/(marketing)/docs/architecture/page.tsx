  ...
  return (
    <div className="space-y-10 pb-20">
      ...
      <section className="space-y-6">
        ...
        <div className="relative w-full bg-zinc-950/50 border border-zinc-900 rounded-2xl p-8 overflow-hidden group">
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-12 z-10">
            ...
            <div
              ...
              className={`flex flex-col items-center gap-3 p-5 rounded-xl border transition-all duration-300 cursor-pointer w-40 ${
                activeNode === "supabase"
          ...
          <div className="mt-10 p-4 bg-zinc-900/80 border border-zinc-800 rounded-xl min-h-[80px] flex items-center justify-center text-center">
            {!activeNode ? (
