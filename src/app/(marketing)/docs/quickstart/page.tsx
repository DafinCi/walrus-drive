...
export default function QuickstartPage() {
  ...
  const TerminalWindow = ({
    ...
    <div className="mt-4 rounded-[6px] overflow-hidden border border-zinc-800 bg-[#0a0a0a] shadow-2xl transition-all hover:border-zinc-700">
      {/* Terminal Header */}
    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="relative border-l border-zinc-800 ml-2 md:ml-4 space-y-12">
        ...
        <div className="relative pl-8">
          ...
          {/* Tab Switcher */}
          <div className="inline-flex items-center p-1 bg-zinc-950 border border-zinc-800 rounded-[6px] mb-2">
            <button
