  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 bg-zinc-950/40 border border-zinc-900 rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="lg:col-span-5 space-y-4 flex flex-col justify-between">
            ...
            <div className="space-y-2 pt-4 border-t border-zinc-900">
              <div className="bg-zinc-950 border border-zinc-800 p-2 rounded-xl font-mono text-[10px] text-zinc-400 truncate select-all">
                {endpoints[activeTab].url}
              </div>
              <button
                onClick={triggerRequest}
                disabled={isLoading}
                className="w-full bg-white text-black hover:bg-zinc-200 disabled:bg-zinc-800 disabled:text-zinc-600 font-bold text-xs py-2.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-colors cursor-pointer"
              >
                {isLoading ? (
          ...
          <div className="lg:col-span-7 bg-[#050505] border border-zinc-800 rounded-xl overflow-hidden flex flex-col min-h-[300px]">
            {/* Window Top Bar */}
      ...
      <section className="bg-zinc-900/20 border border-zinc-900 p-6 rounded-xl space-y-4">
        <div className="flex items-center gap-2 text-zinc-300">
